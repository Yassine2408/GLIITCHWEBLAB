    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-24 bg-gradient-to-b from-primary-50 to-white dark:from-muted-900 dark:to-muted-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-8">
          ...
          <div className="flex justify-center gap-3">
            ...
            <Link
              href="/about"
              className="inline-flex items-center justify-center border border-gray-300 dark:border-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition"
            >
              Learn More
            </Link>
          </div>
